...
class BaseModel:
    ...
    Methods:
        __init__(self): Initializes a new BaseModel instance
        __str__(self): Returns a string representation of the instance.
        save(self): Updates the `updated_at` attribute and saves,
                    the instance to storage.
        to_dict(self): Converts the instance to a dictionary for serialization.
    """
